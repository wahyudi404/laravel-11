<x-layout>
        ...
        <form>
            ...
            <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                <div class="relative w-full">
                    <label for="search"
                        class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Search for article</label>
    ...
    <div class="p-4 mx-auto max-w-screen-xl">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    ...
                    <div class="flex justify-between items-center">
                        <a href="/blog?user={{ $post->user->username }}" class="flex items-center space-x-4">
            ...
            @empty
                <h1 class="col-span-3 text-center font-bold text-2xl opacity-60">Artikel tidak ditemukan!</h1>
            @endforelse
        </div>
    </div>
